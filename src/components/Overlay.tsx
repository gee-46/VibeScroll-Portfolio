    ...
    return (
        <div className="absolute inset-0 z-10 pointer-events-none flex flex-col justify-center">
            <div className="container mx-auto px-6 md:px-12 relative w-full h-full flex items-center">
                ...
                >
                    <h1 className="text-5xl md:text-7xl lg:text-8xl font-heading font-medium tracking-tight text-[#EDEDED] drop-shadow-2xl mb-6 leading-tight">
                        Gautam N Chipkar
                        <span className="block text-accent text-3xl md:text-5xl lg:text-6xl mt-3 font-normal tracking-tight glow-text font-serif italic">
                            AI & Data Science Engineer
                        </span>
                    </h1>
                    <p className="text-secondary text-lg md:text-2xl mt-4 max-w-3xl mx-auto tracking-wide font-light leading-relaxed">
                        Building intelligent systems and <span className="text-[#EDEDED] font-medium">creative digital experiences.</span>
                    </p>
                </motion.div>
